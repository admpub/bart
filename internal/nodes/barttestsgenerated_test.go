...
func TestInsertDelete_BartNode(t *testing.T) {
	t.Parallel()
...
func TestAllIterators_BartNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
...
func TestSupernets4_BartNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))
...
func TestSupernets6_BartNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))
...
func TestSubnets4_BartNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))
...
func TestSubnets6_BartNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))
