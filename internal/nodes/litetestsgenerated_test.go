...
// helpers
func (n *LiteNode[V]) all4() iter.Seq2[netip.Prefix, V] {
...
func (n *LiteNode[V]) all6() iter.Seq2[netip.Prefix, V] {
	return func(yield func(netip.Prefix, V) bool) {
		if n == nil {
			return
		}
...
func (n *LiteNode[V]) allSorted4() iter.Seq2[netip.Prefix, V] {
	return func(yield func(netip.Prefix, V) bool) {
		if n == nil {
			return
		}
...
func (n *LiteNode[V]) allSorted6() iter.Seq2[netip.Prefix, V] {
	return func(yield func(netip.Prefix, V) bool) {
		if n == nil {
			return
		}
...
func TestInsertDelete_LiteNode(t *testing.T) {
	t.Parallel()
...
func TestAllIterators_LiteNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
...
func TestSupernets4_LiteNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))
...
func TestSupernets6_LiteNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))
...
func TestSubnets4_LiteNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))
...
func TestSubnets6_LiteNode(t *testing.T) {
	t.Parallel()
	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))
