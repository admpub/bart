...
func (t *liteTable[V]) flatSorted() golden.Table[V] {
...
func TestTableContainsCompare_liteTable(t *testing.T) {
...
func TestTableLookupCompare_liteTable(t *testing.T) {
	// Create large route tables repeatedly, and compare Table's
	// behavior to a naive and slow but correct implementation.
	t.Parallel()
...
func TestTableLookupPrefixCompare_liteTable(t *testing.T) {
	// Create large route tables repeatedly, and compare Table's
	// behavior to a naive and slow but correct implementation.
	t.Parallel()
...
func TestTableLookupPrefixLPMCompare_liteTable(t *testing.T) {
	// Create large route tables repeatedly, and compare Table's
	// behavior to a naive and slow but correct implementation.
	t.Parallel()
...
func TestTableInsertShuffled_liteTable(t *testing.T) {
...
func TestTableInsertPersistShuffled_liteTable(t *testing.T) {
	// The order in which you insert prefixes into a route table
	// should not matter, as long as you're inserting the same set of
	// routes.
	t.Parallel()
...
func TestTableDeleteCompare_liteTable(t *testing.T) {
...
func TestTableDeleteShuffled_liteTable(t *testing.T) {
...
func TestTableDeleteIsReverseOfInsert_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableDeleteButOne_liteTable(t *testing.T) {
	t.Parallel()
	prng := rand.New(rand.NewPCG(42, 42))
...
func TestTableGetCompare_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableModifySemantics_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableModifyPersistSemantics_liteTable(t *testing.T) {
	t.Parallel()

	if _, isLite := any(new(liteTable[any])).(*liteTable[any]); isLite {
...
func TestTableModifyCompare_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableModifyPersistCompare_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableModifyShuffled_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableModifyPersistShuffled_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableUnionMemoryAliasing_liteTable(t *testing.T) {
	t.Parallel()

	newTable := func(pfx ...string) *liteTable[any] {
		tbl := new(liteTable[any])
		for _, s := range pfx {
...
// between the tables.
func TestTableUnionPersistMemoryAliasing_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableUnionCompare_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableUnionPersistCompare_liteTable(t *testing.T) {
	t.Parallel()
	prng := rand.New(rand.NewPCG(42, 42))
...
func TestTableClone_liteTable(t *testing.T) {
	t.Parallel()
	n := workLoadN()
...
func TestTableCloneShallow_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableCloneDeep_liteTable(t *testing.T) {
	t.Parallel()

	tbl := new(liteTable[*MyInt])
...
func TestTableUnionShallow_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableUnionDeep_liteTable(t *testing.T) {
	t.Parallel()

	tbl1 := new(liteTable[*MyInt])
	tbl2 := new(liteTable[*MyInt])
...
func TestTableOverlapsPrefixEdgeCases_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableSize_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableAll_liteTable(t *testing.T) {
	t.Parallel()
	n := workLoadN()
...
func TestTableAllSorted_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableSubnets_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableSubnetsCompare_liteTable(t *testing.T) {
	t.Parallel()
	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))
...
func TestTableSupernetsEdgeCase_liteTable(t *testing.T) {
	t.Parallel()
...
func TestTableSupernetsCompare_liteTable(t *testing.T) {
	t.Parallel()
	n := workLoadN()
...
func TestTableMarshalText_liteTable(t *testing.T) {
	tests := []struct {
		name         string
...
func TestTableMarshalJSON_liteTable(t *testing.T) {
	tests := []struct {
		name         string
...
func TestTableDumpList4_liteTable(t *testing.T) {
	tests := []struct {
		name         string
		expectedData map[netip.Prefix]string
		expectItems  int
...
func TestTableDumpList6_liteTable(t *testing.T) {
	tests := []struct {
		name         string
		expectedData map[netip.Prefix]string
		expectItems  int
...
func TestTableEqual_liteTable(t *testing.T) {
	t.Parallel()

	n := workLoadN()
	prng := rand.New(rand.NewPCG(42, 42))

	at := new(liteTable[int])
